...
class LocalizationCompletenessTest {
    ...
    private val perLanguageAllowlist: Map<String, Set<String>> = mapOf(
        ...
        // Bokmål keeps these as established, self-consistent loanwords/
        // cognates (Norwegian spells "Bank", "Pause", "Tips", "Type",
        // "Status", "Standard", "Normal", "Pilot", "Journalist" and "Asia"
