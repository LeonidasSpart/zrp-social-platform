      ...
      <div className="max-w-6xl mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-10 md:gap-8">
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-2 text-sm font-inter">
              <li><Link href="/privacy" className="text-zrp-charcoal/70 dark:text-white/70 hover:text-zrp-red transition">Privacy Policy</Link></li>
              <li><Link href="/terms" className="text-zrp-charcoal/70 dark:text-white/70 hover:text-zrp-red transition">Terms of Service</Link></li>
            </ul>
          </div>
        </div>
