  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 md:py-20">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none space-y-6 text-gray-800 dark:text-gray-200">
        <p>
          <span className="font-semibold text-zrp-red">ZRP Social</span> was born from a simple but powerful idea:
          <strong> freedom of speech belongs to everyone.</strong>
        </p>
        ...
        <p>
          We are proud to be the <strong>first Swiss European social media platform</strong>, built on the principles of
        ...
        <p>
          Our mission is simple: <strong>to give a voice to the voiceless.</strong>
        ...
        <p>
          We are not just another social network – we are a movement. A movement that says <em>“enough”</em> to the
        ...
        <p className="text-lg font-semibold text-center text-zrp-red py-4">
