...
export const metadata: Metadata = {
  ...
  description:
    'Press kit for ZRP Social – brand assets, mission, statistics, and contact information for journalists and media.',
};
      ...
      <main>
        ...
        <section className="relative bg-gradient-to-br from-zrp-darkRed to-zrp-deepBlack py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mt-4 text-xl text-white/90 font-inter max-w-2xl mx-auto">
              Media resources, brand assets, and key information about ZRP
              Social.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-zrp-charcoal/80 dark:text-white/70 font-inter leading-relaxed">
                <strong className="text-zrp-red">ZRP Social</strong> is a
                European, Swiss-hosted social media platform built on three
                pillars:
              </p>
              ...
              <ul className="mt-4 space-y-3 font-inter">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-zrp-charcoal/80 dark:text-white/70">
                    ...
                    – No censorship, no algorithm manipulation, no hidden
                    agendas.
                  </span>
                </li>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-zrp-charcoal/80 dark:text-white/70">
                    ...
                    – Strong data protection under Swiss law.
                  </span>
                </li>
            ...
            <div className="bg-zrp-silver/20 dark:bg-zrp-charcoal/50 p-8 rounded-xl border border-zrp-silver/30 dark:border-zrp-charcoal text-center">
              ...
              <p className="text-zrp-charcoal/70 dark:text-white/70 font-inter mt-2">
                ...
                <span className="text-zrp-charcoal dark:text-white font-semibold">
                  orphans, schools, hospitals &amp; climate
                </span>
              </p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              {[
                {
                  title: 'Social Feed',
                  desc: 'Posts, reposts, comments, polls, stories, hashtags – with infinite scroll.',
                },
                {
                  title: 'Real-time Messaging',
                  desc: 'Direct messages with Socket.io – instant and private.',
                },
                {
                  title: 'Creator Monetisation',
                  desc: 'USDC tips (Solana), premium posts, and a creator dashboard with withdrawals.',
                },
                {
                  title: 'Business Plans',
                  desc: 'Custom URLs, recruitment posts, articles, team management, API keys.',
                },
                {
                  title: 'Privacy & Safety',
                  desc: 'Private accounts, mute/block, content reporting, admin moderation.',
                },
                {
                  title: 'Multi-language',
                  desc: 'English, French, German, Italian – more coming.',
                },
              ].map((feature) => (
        ...
        <section className="py-16 px-4 max-w-6xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-zrp-darkRed to-zrp-deepBlack rounded-xl p-8 text-white">
            ...
            <p className="text-xl font-inter mb-6">
              ZRP Social is{' '}
              <strong>not just another social network</strong> – we exist to
              make a difference.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                ...
                <p className="font-inter text-sm opacity-90">
                  of net profits allocated quarterly
                </p>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                ...
                <p className="font-inter text-sm opacity-90">
                  Four causes: orphans, education, healthcare, climate
                </p>
            ...
            <div className="mt-4 text-sm font-inter opacity-80 border-t border-white/20 pt-4">
              📅 Full transparency reports published every three months – first
              report: Q3 2026
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              {[
                ...
                },
                {
                  name: 'Dark Red',
                  hex: '#B10000',
                  class: 'bg-zrp-darkRed',
                },
                {
                  name: 'White',
                  hex: '#FFFFFF',
                  class: 'bg-white border border-zrp-silver/50',
                },
                {
                  name: 'Silver',
                  hex: '#BDDBDB',
                ...
                },
                {
                  name: 'Charcoal',
                  hex: '#0D0D0D',
                  class: 'bg-zrp-charcoal',
                },
                {
                  name: 'Deep Black',
                  hex: '#050505',
                  class: 'bg-zrp-deepBlack',
                },
              ].map((color) => (
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-zrp-silver/10 dark:bg-zrp-charcoal/50 p-6 rounded-xl border border-zrp-silver/30 dark:border-zrp-charcoal">
                ...
                <p className="text-zrp-charcoal/70 dark:text-white/70 font-inter text-sm mt-2">
                  Bold, futuristic, engineered for the future. Used for
                  headings &amp; logo.
                </p>
              ...
              <div className="bg-zrp-silver/10 dark:bg-zrp-charcoal/50 p-6 rounded-xl border border-zrp-silver/30 dark:border-zrp-charcoal">
                ...
                <p className="text-zrp-charcoal/70 dark:text-white/70 font-inter text-sm mt-2">
                  Clean, modern, and highly readable. Used for body text.
                </p>
        ...
        <section className="py-16 px-4 max-w-4xl mx-auto text-center">
          ...
          <blockquote className="text-2xl font-orbitron text-zrp-charcoal dark:text-white italic">
            “We believe social media should be a force for good. ZRP empowers
            people to connect, create, and contribute – without fear, without
            surveillance, and with a direct impact on the world.”
          </blockquote>
